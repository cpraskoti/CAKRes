...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, default=DATA_PATH, help='data path for trainig')
    parser.add_argument('--val_data_path', type=str, default=None, help='validation data path')
    parser.add_argument('--sample_limit', type=int, default=SAMPLE_LIMIT, help='limi maxt number of samples from training data')
    parser.add_argument('--t_skip', type=int, default=T_SKIP, help='time downsampling factor fir training')
    parser.add_argument('--val_t_skip', type=int, default=T_SKIP, help='time downsampling factor for validation data loading')
    parser.add_argument('--n_skip', type=int, default=N_SKIP, help='Spatial downsampling factor')
    ...
    parser.add_argument('--use_cropping', action='store_true', help='Enable random cropping')
    parser.add_argument('--patch_size', type=int, default=64, help='HR patch size for cropping (LR patch size = patch_size // scale)')
    parser.add_argument('--early_stopping_patience', type=int, default=0, help='epochs to wait for improvement before stopping')
    parser.add_argument('--early_stopping_delta', type=float, default=0.0, help='Min change in validation loss for considering improvement')
